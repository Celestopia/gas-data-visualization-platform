    ...
    >
      ...
      <g id="Orb_1_">
        ...
        <image
          width="100%"
          height="100%"
          xlink:href="https://raw.githubusercontent.com/revanth-reddy/arhn2/master/images/Social%20Media%20Aarohan%20Logo.png"
      ...
      <g id="ring2">
        <path
          fill="#C5FFFD"
          d="M328.4,328.7c0,0-0.8,0.7-2.3,2.2c-1.6,1.4-3.9,3.3-7.3,5.5c-3.4,2.1-7.8,4.4-13.3,6.4
      ...
      <g id="ring3">
        <path
          fill="#C5FFFD"
          d="M328.7,74.9c0,0,0.7,0.8,2.2,2.3c1.4,1.6,3.3,3.9,5.5,7.3c2.1,3.4,4.4,7.8,6.4,13.3c2,5.5,3.7,12,5.2,19.3
